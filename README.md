...
一个基于 Flask 的题库练习与模拟考试系统，支持电脑和手机浏览器使用。
...
- 答案解析、考点、来源展示
- 错题本、收藏、历史记录
- 本机自动登录、限流、基础反爬、安全响应头

## 题库数据

本仓库包含公开版题库：`webapp/data/questions_public.json`，共 1660 题。
...
公开版题库保留题干、选项、答案、解析、考点和分类信息，可以直接运行做题。
...
本机使用也可以直接双击 `webapp/start_share.bat`，启动后打开 `http://127.0.0.1:5000`。默认不需要账号密码。
